...
describe("AnnularSectionCalculator", () => {
  it("計算結果の照合 (1)", () => {
    ...
    expect(result.steelRatioPercent).toBeCloseTo(0.31, 2); // 鉄筋比 [%]
    ...
    expect(result.steelStressNPerMm2).toBeCloseTo(328.7, 1); // 鉄筋曲げ引張応力度 [N/mm2]
  ...
  it("計算結果の照合 (2)", () => {
    ...
    expect(result.steelRatioPercent).toBeCloseTo(0.21, 2); // 鉄筋比 [%]
    ...
    expect(result.steelStressNPerMm2).toBeCloseTo(0.3, 1); // 鉄筋曲げ引張応力度 [N/mm2]
  ...
  it("計算結果の照合 (曲げモーメントのみ)", () => {
    ...
    expect(result.steelRatioPercent).toBeCloseTo(0.72, 2); // 鉄筋比 [%]
    ...
    expect(result.steelStressNPerMm2).toBeCloseTo(0.1, 1); // 鉄筋曲げ引張応力度 [N/mm2]
