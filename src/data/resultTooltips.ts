...
export const resultTooltips: Record<string, TooltipContent> = {
  x: {
    title: "中立軸位置",
    lines: [math`x = \frac{f_c}{f_c + f_s}(r_o + r_s)`],
  },
  M_o: {
    title: "合成曲げモーメント",
    lines: [math`M_o = M + N \times r`],
  },
  sigma_c: {
    title: "コンクリート圧縮応力度",
    lines: [math`\sigma_c = \dfrac{M_o}{r^3} \times f_c`],
  },
  sigma_s: {
    title: "鉄筋引張応力度",
    lines: [math`\sigma_s=\min(E_s\,\epsilon_s,\,\sigma_{sy})`],
  },
  tau: {
    title: "コンクリートせん断応力度",
    lines: [
  ...
  A_c: {
    title: "コンクリート総断面積",
    lines: [math`A_c = \dfrac{\pi}{2} (r^2 - r_0^2)`],
  },
  p: {
    title: "鉄筋比（コンクリート実断面）",
    lines: [math`p = \dfrac{A_s}{A_c} \times 100\%`],
  },
  theta: {
    title: "中立軸角度",
    lines: [
  ...
  alpha: {
    title: "幾何係数",
    lines: [math`\alpha = \dfrac{r_s}{r}`],
  },
  beta: {
    title: "幾何係数",
    lines: [math`\beta  = \dfrac{M}{N r}`],
  },
  gamma: {
    title: "幾何係数",
    lines: [math`\gamma = \dfrac{r_0}{r}`],
  },
  f_c: {
    title: "コンクリート圧縮応力度係数",
    lines: [
